            ...
            imports: [
                ...
                _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_8__["JwtModule"].forRoot({
                    config: {
                        ...
                        whitelistedDomains: [_environments_environment__WEBPACK_IMPORTED_MODULE_9__["environment"].apiUrl],
                        blacklistedRoutes: [_environments_environment__WEBPACK_IMPORTED_MODULE_9__["environment"].apiUrl + '/auth/login']
                    }
                })
            ],
            providers: [],
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (formData) {
        var _this = this;
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + "/auth/login", formData)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (val) {
...
module.exports = __webpack_require__(/*! C:\Users\User\Desktop\Front-end\src\main.ts */"./src/main.ts");
